 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation InsertUserOne($input: user_insert_input!) {\n    insert_user_one(object: $input) {\n        id,\n    }\n}"): (typeof documents)["mutation InsertUserOne($input: user_insert_input!) {\n    insert_user_one(object: $input) {\n        id,\n    }\n}"];
